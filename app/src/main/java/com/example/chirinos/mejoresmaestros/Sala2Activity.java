...
public class Sala2Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Integer llenarSala2, idLector, idEncargado1, idAyudante1, idEncargado2, idAyudante2, idEncargado3, idAyudante3, diaAsignacion, mesAsignacion, anualAsignacion, numSemana;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAyudante1 = (TextView) findViewById(R.id.ayudante1Sala2);
        tvEncargado2 = (TextView) findViewById(R.id.encargado2Sala2);
        tvAyudante2 = (TextView) findViewById(R.id.ayudante2Sala2);
        tvEncargado3 = (TextView) findViewById(R.id.encargado3Sala2);
        tvAyudante3 = (TextView) findViewById(R.id.ayudante3Sala2);
        tvFecha = (TextView) findViewById(R.id.fechaSala2);
        tvAsigLectura = (TextView) findViewById(R.id.tvAsigLecturaSala2);
        tvAsignacion1 = (TextView) findViewById(R.id.asignacion1Sala2);
        tvAsignacion2 = (TextView) findViewById(R.id.asignacion2Sala2);
        tvAsignacion3 = (TextView) findViewById(R.id.asignacion3Sala2);
        calendar = Calendar.getInstance();

        bundleRecibir = this.getIntent().getExtras();
        llenarSala2 = bundleRecibir.getInt("llenarSala2");
    ...
    public void guradarSala2() {
        ...
        Cursor fila = db.rawQuery("SELECT * FROM sala2 WHERE semana =" + semana, null);
        if (fila.moveToFirst()) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(Sala2Activity.this, R.style.Theme_Dialog_Publicador);
            ...
            dialog.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    db.update("sala2", registro, "semana=" + semana, null);
                    guardarInformacion ();
